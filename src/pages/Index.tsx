...
const Index = () => {
  ...
  const handleGetStarted = () => {
    // handleProtectedAction(() => { temporary blocked
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center text-black mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-500 mb-8 max-w-3xl mx-auto">
              Create personalized itineraries with our Itinerary travel generator.
              Discover amazing destinations and plan unforgettable experiences.
            </p>
          ...
          <div id="features" className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="bg-white/10 backdrop-blur-sm border-0 text-white p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-blue-500 mb-3">Smart Planning</h3>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-0 text-white p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-blue-500 mb-3 ">Discover Places</h3>
              <p className="text-gray-500">
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-0 text-white p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-blue-500 mb-3">Perfect Timing</h3>
              <p className="text-gray-500">
          ...
          <div className="text-center">
            <Card className="bg-white/95 backdrop-blur-sm border-0 shadow-soft rounded-3xl p-12 max-w-4xl mx-auto">
              ...
              <p className="text-gray-600 mb-8 text-lg">
                Join thousands of travelers who have discovered their perfect destinations with our platform.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  onClick={handleGetStarted}
