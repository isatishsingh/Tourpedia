...
import TestimonialFormSection from "@/components/testimonialForm";
...
const Testimonial = () => {
  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
            <div>
              <p className="uppercase text-xl text-white font-semibold tracking-wide mb-2">
                <span className="bg-yellow-500 px-2">Testimonial</span>
              </p>
            ...
            <div className="bg-blue-900 text-white rounded-2xl p-8 text-center">
              ...
              <div className="flex justify-center gap-2 mb-3 text-yellow-400 text-2xl">
                ★ ★ ★ ★ ★
              </div>
              <p className="text-sm">See over 16,851 reviews on</p>
              <a
                href="#"
                className="underline text-sm hover:text-teal-300 font-medium"
              >
                ReviewSite
              </a>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl shadow-md p-6 transition transform duration-300 hover:-translate-y-3 hover:scale-105 hover:shadow-2xl cursor-pointer"
              >
      ...
      {/* ✅ FORM SECTION COMES AFTER THE PINK SECTION */}
